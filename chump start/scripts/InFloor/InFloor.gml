/// @description checks to see if position is bekow he floor height of a given tile, returns how deep in floor
/// @arg tilemap
/// @arg x
/// @arg y
function InFloor(argument0, argument1, argument2) {
